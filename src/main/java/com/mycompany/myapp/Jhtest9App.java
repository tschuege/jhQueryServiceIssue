...
public class Jhtest9App {

    private static final Logger log = LoggerFactory.getLogger(Jhtest9App.class);

    private final Environment env;

    public Jhtest9App(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(Jhtest9App.class);
